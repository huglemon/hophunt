...
export const config = {
	...
	thankYou: {
		...
		couponCode: process.env.NEXT_PUBLIC_COUPON_CODE || '', // 优惠码，如果为空，则不显示优惠码
		couponDiscount: process.env.NEXT_PUBLIC_COUPON_DISCOUNT || '', 
		couponImage: process.env.NEXT_PUBLIC_COUPON_IMAGE || '', // 也可以是微信群二维码等, 如果为空，则显示优惠码
	},
